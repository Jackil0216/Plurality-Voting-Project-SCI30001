...
```{r}
set.seed(1)
(PPR_simulation(c(0.4,0.6), up_limit=0.05))
(PPR_simulation(c(0.45,0.55), up_limit=0.05))
(PPR_simulation(c(0.5,0.5), up_limit=0.05))
(PPR_simulation(c(0.52,0.48), up_limit=0.05))
(PPR_simulation(c(0.55,0.45), up_limit=0.05))
(PPR_simulation(c(0.65,0.35), up_limit=0.05))
```

alpha=0.01 set
```{r}
set.seed(1)
(PPR_simulation(c(0.4,0.6), up_limit=0.01))
(PPR_simulation(c(0.45,0.55), up_limit=0.01))
(PPR_simulation(c(0.5,0.5), up_limit=0.01))
(PPR_simulation(c(0.52,0.48), up_limit=0.01))
(PPR_simulation(c(0.55,0.45), up_limit=0.01))
(PPR_simulation(c(0.65,0.35), up_limit=0.01))
```
...
```{r}
set.seed(1)
(PPR_simulation(c(0.2,0.6,0.2), up_limit=0.05))
(PPR_simulation(c(0.49,0.48,0.03), up_limit=0.05))
(PPR_simulation(c(0.7,0.2,0.1), up_limit=0.05))
(PPR_simulation(c(0.4,0.3,0.3), up_limit=0.05))
(PPR_simulation(c(0.34,0.33,0.33), up_limit=0.05))
(PPR_simulation(c(0.3,0.4,0.3), up_limit=0.05))
```
...
```{r}
set.seed(1)
(PPR_simulation(c(0.2,0.6,0.2), up_limit=0.01))
(PPR_simulation(c(0.3,0.4,0.3), up_limit=0.01))
(PPR_simulation(c(0.34,0.33,0.33), up_limit=0.01))
(PPR_simulation(c(0.49,0.48,0.03), up_limit=0.01))
(PPR_simulation(c(0.4,0.3,0.3), up_limit=0.01))
(PPR_simulation(c(0.7,0.2,0.1), up_limit=0.01))
```
...
```{r}
set.seed(1)
lapply(five_candidate_pT, PPR_simulation)
```
alpha=0.01 set
```{r}
set.seed(1)
